...
const TITLE = 'US Public Health Agency Vaccination Certificate';
  ...
  issuerVendors.forEach(issuerVendor => {
    verifierVendors.forEach(verifierVendor => {
      ...
      describe(`[${TITLE}] ${VENDOR_TITLE}`, () => {
        ...
        it('issues a Vaccination Certificate credential', async () => {
        ...
        it('verifies a Vaccination Certificate credential', async () => {
